...
class ChatProcessor:
    ...
    def setup_qa_chain(self):
        ...
        Provide a clear, helpful, and conversational response. Include specific details when available. 
        If you're sharing tips, format them in a user-friendly way. If you're giving schedule information, be precise.
        """
    ...
    def process_message(self, message, session_id=None):
        try:
            ...
            if len(response.split()) < 10:
                ...
                Please enhance this response to be more helpful, detailed and conversational. Include practical 
                advice relevant to waste management. Make sure the response sounds friendly and helpful.
                """
